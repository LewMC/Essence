...
public class CommandGamemode implements CommandExecutor {
    ...
    public boolean onCommand(
        ...
        Player player;
        UtilPlayer playerUtil = new UtilPlayer(this.plugin, this.cs);
        this.message = new UtilMessage(this.plugin, cs);
        this.cs = cs;
